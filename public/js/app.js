...
var initAdmin = function initAdmin() {
  ...
  function renderItems(items) {
    var parsedItem = Object.values(items);
    return parsedItem.map(function (menuItem) {
...
var addtToCart = document.querySelectorAll('.add-to-cart');
...
addtToCart.forEach(function (btn) {
...
var hidden_input = document.querySelector('#hidden-input');
var order = hidden_input ? hidden_input.value : null;
...
socket.on('orderUpdated', function (data) {
  ...
  UpdatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_3___default()().format('hh:mm A');
